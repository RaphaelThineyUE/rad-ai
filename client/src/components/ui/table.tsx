...
const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot ref={ref} className={cn("border-t bg-pink-50 font-medium [&>tr]:last:border-b-0", className)} {...props} />
  )
);
...
>(({ className, hover, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-pink-100 transition-colors",
      hover && "hover:bg-rose-50 data-[state=selected]:bg-rose-50",
      className
    )}
    {...props}
  />
...
// TableContainer for MUI compatibility
